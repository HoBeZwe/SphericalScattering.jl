...
@testset "Electric ring current" begin
    ...
    ex = electricRingCurrent(; wavenumber=30.0, center=SVector(0.0, 0.0, 2.0), radius=0.5) # ≈ 10 MHz
...
@testset "Magnetic ring current" begin
    ...
    ex = magneticRingCurrent(; wavenumber=30.0, center=SVector(0.0, 0.0, 2.0), radius=0.5) # ≈ 10 MHz
